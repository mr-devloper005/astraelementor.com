...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-[#ced9d1] bg-white p-8 text-center shadow-[0_18px_54px_rgba(21,51,58,0.06)]', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-[0.85rem] bg-[var(--slot4-accent-fill)] px-5 py-3 text-sm font-black text-white">
        {actionLabel}
